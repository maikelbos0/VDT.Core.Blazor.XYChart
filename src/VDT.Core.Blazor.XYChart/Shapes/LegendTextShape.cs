...
public class LegendTextShape : ShapeBase {
    ...
    /// <summary>
    /// Gets the X-coordinate of the anchor for the legend text
    /// </summary>
    public decimal X { get; }

    /// <summary>
    /// Gets the Y-coordinate of the anchor for the legend text
    /// </summary>
    ...
    /// </summary>
    /// <param name="x">X-coordinate of the anchor for the legend text</param>
    /// <param name="y">Y-coordinate of the anchor for the legend text</param>
